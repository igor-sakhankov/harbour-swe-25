...
public class ObjectFactory {
    ...
    private <T> T getInstanceFromInterface(Class<T> clazz) throws InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, InvocationTargetException {
